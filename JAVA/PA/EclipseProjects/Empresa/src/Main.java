...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("Numero total de Empresas: "+ Empresa.obtemNumTotalEmpresas());
		...
		empresa2.atualizaNumeroDeEmpregado(empregado3, empregado4.getNumeroEmpregado());
		empresa2.atualizaNumeroDeEmpregado(empregado3, "01351_2019");
		
		System.out.println(empresa1.listaEmpregados());
		System.out.println(empresa2.listaEmpregados());
	}
